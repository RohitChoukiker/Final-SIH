...
export const AddressForm: React.FC<AddressFormProps> = ({
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative">
        ...
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 px-3 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 dark:bg-white-700 dark:border-gray-600"
            required
          />
        </div>
      </div>
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 dark:text-black-380 mb-1">
          PIN Code
        </label>
        <input
          type="text"
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 dark:text-black-700 mb-1">
          Contact Number
        </label>
        <input
          type="tel"
